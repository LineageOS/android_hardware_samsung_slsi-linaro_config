...
$(call soong_config_set,exynos_hwc,uses_dqe_interface,true)
endif

ifeq ($(BOARD_USES_DISPLAY_COLOR_INTERFACE), true)
$(call soong_config_set,exynos_hwc,uses_display_color_interface,true)
endif
...
$(call soong_config_set,exynos_hwc,USES_VIRTUAL_DISPLAY,true)
endif

ifeq ($(TARGET_ARCH), arm64)
$(call soong_config_set,exynos_hwc,USES_ARCH_ARM64,true)
endif
...
$(call soong_config_set,exynos_hwc,USES_DOZEMODE,true)
endif


ifeq ($(BOARD_USES_HWC_CPU_PERF_MODE), true)
$(call soong_config_set,exynos_hwc,USES_HWC_CPU_PERF_MODE,true)
endif

ifeq ($(BOARD_USES_DUAL_DISPLAY), true)
$(call soong_config_set,exynos_hwc,USES_DUAL_DISPLAY,true)
endif
...
ifeq ($(BOARD_USES_DISPLAY_COLOR_INTERFACE), true)
$(call soong_config_set,exynos_hwc,USE_DISPLAY_COLOR_INTERFACE,true)
endif

ifeq ($(HWC_DISABLE_WIN_UPDATE), true)
$(call soong_config_set,exynos_hwc,HWC_DISABLE_WIN_UPDATE,true)
endif

ifeq ($(BOARD_USES_DYNAMIC_RECOMPOSITION), true)
$(call soong_config_set,exynos_hwc,ENABLE_DYNAMIC_RECOMP,true)
endif

ifeq ($(BOARD_USES_HWC_FORCE_GPU), true)
$(call soong_config_set,exynos_hwc,ENABLE_FORCE_GPU,true)
endif

ifeq ($(BOARD_USES_HWC_OLD_VSYNC_STRUCT), true)
$(call soong_config_set,exynos_hwc,USE_NOT_RESERVED_FIELD,true)
endif
