...
$(call soong_config_set_bool,openmax,USE_EXYNOS_MEDIA_EXT,true)
endif

# since 3.10 kernel
ifneq ($(filter-out 3.4, $(TARGET_LINUX_KERNEL_VERSION)),)
$(call soong_config_set_bool,openmax,USE_DEFINE_H264_SEI_TYPE,true)
endif

# since 3.18 kernel
ifneq ($(filter-out 3.4 3.10, $(TARGET_LINUX_KERNEL_VERSION)),)
$(call soong_config_set_bool,openmax,USE_ORIGINAL_HEADER,true)
$(call soong_config_set_bool,openmax,USE_MFC_HEADER,true)
endif
...
$(call soong_config_set_bool,openmax,USE_HEVC_HWIP,true)
endif

ifeq ($(BOARD_USE_DEINTERLACING_SUPPORT), true)
$(call soong_config_set_bool,openmax,USE_DEINTERLACING_SUPPORT,true)
endif

ifeq ($(BOARD_USE_SINGLE_PLANE_IN_DRM), true)
$(call soong_config_set_bool,openmax,USE_SINGLE_PLANE_IN_DRM,true)
endif
...
$(call soong_config_set_bool,openmax,USE_DMA_BUF,true)
endif

ifeq ($(BOARD_USE_CSC_HW), true)
$(call soong_config_set_bool,openmax,USE_CSC_HW,true)
endif

ifeq ($(BOARD_USE_NON_CACHED_GRAPHICBUFFER), true)
$(call soong_config_set_bool,openmax,USE_NON_CACHED_GRAPHICBUFFER,true)
endif
...
$(call soong_config_set_bool,openmax,USE_WA_ION_BUF_REF,true)
endif
...
$(call soong_config_set_bool,openmax,OMX_USES_EPIC,true)
endif

ifeq ($(BOARD_USES_EXYNOS_DATASPACE_FEATURE), true)
$(call soong_config_set_bool,openmax,USE_BT709_SUPPORT,true)
endif

ifeq ($(BOARD_USES_EXYNOS_GRALLOC_VERSION), 0)
$(call soong_config_set_bool,openmax,GRALLOC_VERSION0,true)
$(call soong_config_set_bool,openmax,USE_PRIV_FORMAT,true)
else
$(call soong_config_set_bool,openmax,USE_PRIV_USAGE,true)
endif

ifeq ($(BOARD_USE_SKYPE_HD), true)
$(call soong_config_set_bool,openmax,USE_SKYPE_HD,true)
endif

ifeq ($(BOARD_USE_FULL_ST2094_40), true)
$(call soong_config_set_bool,openmax,USE_FULL_ST2094_40,true)
$(call soong_config_set_bool,exynos_headers_c2,full_st2094_40,true)
endif

ifeq ($(BOARD_USE_HDR10PLUS_STAT_ENC), true)
$(call soong_config_set_bool,openmax,USE_HDR10PLUS_STAT_ENC,true)
endif
...
$(call soong_config_set_bool,openmax,EGL_IMAGE_SUPPORT,true)
endif

ifeq ($(EXYNOS_OMX_SUPPORT_TUNNELING), true)
$(call soong_config_set_bool,openmax,TUNNELING_SUPPORT,true)
endif

ifneq ($(BOARD_NOT_SUPPORT_DCPP), true)
$(call soong_config_set_bool,openmax,USE_SECURE_WITH_NONSECURE,true)
endif

ifeq ($(BOARD_USE_SINGLE_DRM), true)
$(call soong_config_set_bool,openmax,USE_SINGLE_DRM,true)
endif
...
$(call soong_config_set_bool,openmax,USE_SMALL_SECURE_MEMORY,true)
endif

ifeq ($(BOARD_USE_COMPRESSED_COLOR), true)
$(call soong_config_set_bool,openmax,USE_COMPRESSED_COLOR,true)
endif

ifeq ($(BOARD_USE_S3D_SUPPORT), true)
$(call soong_config_set_bool,openmax,USE_S3D_SUPPORT,true)
endif

ifeq ($(BOARD_USE_CUSTOM_COMPONENT_SUPPORT), true)
$(call soong_config_set_bool,openmax,USE_CUSTOM_COMPONENT_SUPPORT,true)
endif

ifeq ($(BOARD_USE_VP9DEC_SUPPORT), true)
$(call soong_config_set_bool,openmax,USE_VP9DEC_SUPPORT,true)
endif

ifeq ($(BOARD_USE_GSC_RGB_ENCODER), true)
$(call soong_config_set_bool,openmax,USE_HW_CSC_GRALLOC_SOURCE,true)
endif

ifeq ($(BOARD_USE_FIMC_RGB_ENCODER), true)
$(call soong_config_set_bool,openmax,USE_FIMC_RGB_ENCODER,true)
endif


ifeq ($(BOARD_USE_VIDEO_EXT_FOR_WFD_HDCP), true)
$(call soong_config_set_bool,openmax,USE_VIDEO_EXT_FOR_WFD_HDCP,true)
endif

ifeq ($(BOARD_USE_WFDENC_SUPPORT), true)
$(call soong_config_set_bool,openmax,USE_WFDENC_SUPPORT,true)
endif

ifeq ($(BOARD_USE_HEVCENC_SUPPORT), true)
$(call soong_config_set_bool,openmax,USE_HEVCENC_SUPPORT,true)
endif

ifeq ($(BOARD_USE_VP9ENC_SUPPORT), true)
$(call soong_config_set_bool,openmax,USE_VP9ENC_SUPPORT,true)
endif

ifeq ($(BOARD_DISABLE_RAPID_COMPONENT_LOAD), true)
$(call soong_config_set_bool,openmax,USE_DISABLE_RAPID_COMPONENT_LOAD,true)
endif

ifeq ($(BOARD_USE_NON_DRM_CODEC_ONLY), true)
$(call soong_config_set_bool,openmax,USE_NON_DRM_CODEC_ONLY,true)
endif

ifeq ($(BOARD_USE_CSC_FILTER), true)
$(call soong_config_set_bool,openmax,USE_CSC_FILTER,true)
endif

ifeq ($(BOARD_SUPPORT_MFC_ENC_RGB), true)
$(call soong_config_set_bool,openmax,SUPPORT_MFC_ENC_RGB,true)
endif

ifeq ($(BOARD_USE_GDC), true)
$(call soong_config_set_bool,openmax,USE_GDC,true)
endif

ifeq ($(BOARD_SUPPORT_MFC_ENC_BT2020), true)
$(call soong_config_set_bool,openmax,SUPPORT_MFC_ENC_BT2020,true)
endif
...
$(call soong_config_set_bool,openmax,USE_DEC_SW_CSC,true)
endif

ifeq ($(BOARD_USE_BLOB_ALLOCATOR), true)
$(call soong_config_set_bool,openmax,USE_BLOB_ALLOCATOR,true)
endif
...
$(call soong_config_set_bool,openmax,USE_FILMGRAIN_FILTER,true)
endif

ifeq ($(BOARD_USE_SUPPORT_GPU_SBWC), true)
$(call soong_config_set_bool,openmax,USE_SUPPORT_GPU_SBWC,true)
endif

ifeq ($(BOARD_USE_FLEXIBLE_P010), true)
$(call soong_config_set_bool,openmax,USE_FLEXIBLE_P010,true)
endif
